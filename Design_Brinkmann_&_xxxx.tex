...
\begin{document}
	...
	\subsubsection*{Aktivitäten:}
	- Einlesen von n\\
	- ergebnis und zähler gleich n\\
	- n -1\\
	- Solange zähler größer als 0, mach\\
	$\rightarrow$ ergebnis * zähler; sowie zähler hochzählen\\
	-Ausgabe: ergebnis
	...
	- restSekunden = restSekunden \% 60\\
		$\rightarrow$ Alle Minuten aus restSekunden rausrechnen, übrig bleiben nur Sekunden, ohne Min, Stunden oder Tage\\
